...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="https://fielgroup.com.mx/villa/material/libs/sweetalert2/sweetalert2.min.css">
    ...
    <body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl footer-offset">
        ...
        <script src="https://fielgroup.com.mx/villa/material/libs/sweetalert2/sweetalert2.min.js"></script>
