<x-modal.modal id="ModalUsuarios" size="modal-lg">
    ...
    <x-slot name="body">
        <form class="js-validate needs-validation" novalidate="" data-name="FormUsuarios" id="FormUsuarios" method="POST" action="{{ route('usuarios.store') }}">
            ...
            <x-form.input-double >
                <x-slot name="primero">
                    <x-form.input tipo="text" id="name" titulo="Nombre/s" holder="" required="true"></x-form.input>
                </x-slot>
                <x-slot name="segundo">
                    <x-form.input tipo="text" id="apellidos" titulo="Apellidos" holder="" required="true"></x-form.input>
                </x-slot>
            </x-form.input-double>

            <x-form.input-double >
                <x-slot name="primero">
                    <x-form.input tipo="email" id="email" titulo="Correo electrónico" holder="" required="true"></x-form.input>
                </x-slot>

                <x-slot name="segundo">
                    <x-form.input tipo="text" id="password_plain" titulo="Contraseña" holder="" required="true"
            ...
            <x-form.input-double >
                <x-slot name="primero">
                    <x-form.select tipo="email" id="rol" titulo="rol" holder="" required="true"></x-form.select>
                </x-slot>
            </x-form.input-double>
